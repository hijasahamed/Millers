...
class HomeScreenCollections extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        HomeScreenCollectionTitle(screenSize: screenSize),
        HomeScreenCollectionLists(screenSize: screenSize),
      ],
    );
  }
}

class HomeScreenCollectionLists extends StatelessWidget {
  const HomeScreenCollectionLists({
    super.key,
    required this.screenSize,
  });
...
class HomeScreenCollectionTitle extends StatelessWidget {
  const HomeScreenCollectionTitle({
    super.key,
    required this.screenSize,
  });
